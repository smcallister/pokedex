...
func GetPokemon(name string) (*Pokemon, error) {
	...
	// Query for the specific pokemon.
	...
	// Convert the result to a Pokemon struct.
	...
	if len(body) == 0 {
		return nil, fmt.Errorf("Empty response body for pokemon")
	}
	...
	// Cache the result and return the pokemon.
	cache.Add(url, body)
	return &pokemon, nil
}